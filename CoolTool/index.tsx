...
const CoolTool = () => {
    ...
    function displayWidth() {
        ...
        allElements.forEach((element) => {
            ...
            if (element.clientWidth === 0 || !element.parentElement || element.id === "CoolToolbarButton") return
    ...
    function measureDistance() {
        ...
        for (let i = 1; i < allElements.length; i++) {
            ...
            if (element.clientWidth === 0 || !element.parentElement || element.id === "CoolToolbarButton") continue
    ...
    return (
        ...
        >
            ...
            <div
                ...
                <button id="CoolToolbarButton" onClick={addMargins}> Margin debugger</button>
                <button id="CoolToolbarButton" onClick={displayWidth}>Display Width</button>
                <button id="CoolToolbarButton" onClick={measureDistance}>Measure Distance</button>
                <button id="CoolToolbarButton" onClick={mouseRuler}>Mouse ruler</button>
